 ...
 * enumeration oracle (OWASP ASVS 2.1). The same rule applies to forgot-password, which
 * never calls this mapper at all — see apps/mobile/src/app/(auth)/forgot-password.tsx.
 */
