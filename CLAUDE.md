...
- **Phase:** In development. M0 (foundation), M1 (auth & identity), M2 (clients & intake), M3 (programming), M4a (log core) and M4b (offline + live mirror) are complete. M4c (body metrics and progress photos) is next. M4 was split into four sub-milestones on 2026-09-18 — see the M4a spec for why.
...
| M4c | Body — EP-06 metrics, progress photos, encryption decision | next |
