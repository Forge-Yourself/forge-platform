...
- **Phase:** In development. M0 (foundation), M1 (auth & identity), M2 (clients & intake), M3 (programming), M4a (log core), M4b (offline + live mirror) and M4c (body metrics and progress photos) are complete. M4d (floor ergonomics: iPad console, voice, Live Activity) is next. M4 was split into four sub-milestones on 2026-09-18 — see the M4a spec for why.
...
| M4d | Floor ergonomics — iPad console, voice logging, Live Activity rest timer | next |
